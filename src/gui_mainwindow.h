...
static Fl_Menu_Item operator_type_options[] = {
    {SCHEDULE_FLOAT_OPERATOR_SET}, {SCHEDULE_FLOAT_OPERATOR_PLUS}, 
    {SCHEDULE_FLOAT_OPERATOR_MINUS}, {SCHEDULE_FLOAT_OPERATOR_MULT}, 
    {SCHEDULE_FLOAT_OPERATOR_DIVIDE}, {SCHEDULE_FLOAT_OPERATOR_ROUND}, 
    {SCHEDULE_FLOAT_OPERATOR_COUNT_IMAGES}, {SCHEDULE_FLOAT_OPERATOR_COUNT_WORDS}, 
    {SCHEDULE_FLOAT_OPERATOR_READ_STAR}, {SCHEDULE_FLOAT_OPERATOR_READ_STAR_TABLE_MAX}, 
    {SCHEDULE_FLOAT_OPERATOR_READ_STAR_TABLE_MIN}, {SCHEDULE_FLOAT_OPERATOR_READ_STAR_TABLE_AVG}, 
    {SCHEDULE_FLOAT_OPERATOR_READ_STAR_TABLE_SORT_IDX}, {SCHEDULE_BOOLEAN_OPERATOR_AND}, 
    {SCHEDULE_BOOLEAN_OPERATOR_OR}, {SCHEDULE_BOOLEAN_OPERATOR_NOT}, 
    {SCHEDULE_BOOLEAN_OPERATOR_GT}, {SCHEDULE_BOOLEAN_OPERATOR_LT}, 
    {SCHEDULE_BOOLEAN_OPERATOR_EQ}, {SCHEDULE_BOOLEAN_OPERATOR_GE}, 
    {SCHEDULE_BOOLEAN_OPERATOR_LE}, {SCHEDULE_BOOLEAN_OPERATOR_FILE_EXISTS}, 
    {SCHEDULE_BOOLEAN_OPERATOR_READ_STAR}, {SCHEDULE_STRING_OPERATOR_JOIN}, 
    {SCHEDULE_STRING_OPERATOR_BEFORE_FIRST}, {SCHEDULE_STRING_OPERATOR_BEFORE_LAST}, 
    {SCHEDULE_STRING_OPERATOR_AFTER_FIRST}, {SCHEDULE_STRING_OPERATOR_AFTER_LAST}, 
    {SCHEDULE_STRING_OPERATOR_READ_STAR}, {SCHEDULE_STRING_OPERATOR_GLOB}, 
    {SCHEDULE_STRING_OPERATOR_NTH_WORD}, {SCHEDULE_OPERATOR_TOUCH_FILE}, 
    {SCHEDULE_OPERATOR_COPY_FILE}, {SCHEDULE_OPERATOR_MOVE_FILE}, 
    {SCHEDULE_OPERATOR_DELETE_FILE}, {SCHEDULE_WAIT_OPERATOR_SINCE_LAST_TIME}, 
    {SCHEDULE_EMAIL_OPERATOR}, {SCHEDULE_EXIT_OPERATOR}, 
    {0}
};
