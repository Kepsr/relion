...
bool EMDL::isValidLabel(const std::string &labelName) {
    return EMDL::isValidLabel(EMDL::str2Label(labelName));
}

class EMDL::StaticInitialization {
    ...
    StaticInitialization() {
        ...
        EMDL::addLabel<bool>       (EMDL::JOB_IS_CONTINUE, "rlnJobIsContinue", "Is this a continuation job?");
...
} EMDL::initialization;  // Instantiate
