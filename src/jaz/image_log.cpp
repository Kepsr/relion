...
void ImageLog::write(
    ...
    if (polar) {
        Image<RFLOAT> argImg = FilterHelper::getPhase(img);
        Image<RFLOAT> absImg = FilterHelper::getAbs(img);
        ...
        Image<RFLOAT> realImg = FilterHelper::getReal(img);
        Image<RFLOAT> imagImg = FilterHelper::getImag(img);
