...
class OptimisationParamters {
    ...
    metadata_offset(0), my_ori_particle(my_ori_particle) {
...
class IndexedDataArrayMask {
    ...
    inline IndexedDataArrayMask(CudaCustomAllocator *allocator):
    jobOrigin(allocator),
    jobExtent(allocator),
    firstPos(),
    lastPos(),
...
class IndexedDataArray {
    ...
    inline IndexedDataArray(CudaCustomAllocator *allocator):
        weights(allocator),
        rot_id(allocator),
        rot_idx(allocator),
        trans_idx(allocator),
    ...
    inline IndexedDataArray(IndexedDataArray &parent, IndexedDataArrayMask &mask, CudaCustomAllocator *allocator):
