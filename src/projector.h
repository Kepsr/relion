...
void run_CenterFFTbySign(
    Complex *img_in, int xSize, int ySize, int zSize, cudaStream_t = 0
);
...
class Projector {
    ...
    /** Constructor with parameters
      ...
      * @endcode
      */
    Projector(int _ori_size, int _interpolator = TRILINEAR, float _padding_factor_3d = 2.0, int _r_min_nn = 10, int _data_dim = 2) {
     ...
     *
     */
    void computeFourierTransformMap(
