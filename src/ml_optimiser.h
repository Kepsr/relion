...
enum {
    ...
    METADATA_CTF_DEFOCUS_U,
    METADATA_CTF_DEFOCUS_V,
    METADATA_CTF_DEFOCUS_ANGLE,
    METADATA_CTF_BFACTOR,
    METADATA_CTF_KFACTOR,
    METADATA_CTF_PHASE_SHIFT,
    ...
    METADATA_YOFF_PRIOR,
    METADATA_ZOFF_PRIOR,
    METADATA_PSI_PRIOR_FLIP_RATIO,
    METADATA_ROT_PRIOR_FLIP_RATIO, 	// KThurber

    METADATA_LINE_LENGTH_BEFORE_BODIES,
};

const int METADATA_NR_BODY_PARAMS = 6;
