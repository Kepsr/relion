...
// Remove until prefix .....................................................
FileName FileName::removeUntilPrefix(const std::string &prefix) const {
    if (prefix.length() == 0) return *this;
    int i = find(prefix);
    if (i == -1) return *this;
    return ((FileName) *this).erase(0, i + prefix.length());
}

// Remove directories ......................................................
FileName FileName::removeDirectories(int keep) const {
    int islash = rfind("/");
    for (int depth = 0; depth < keep; depth++) {
        islash = rfind("/", islash - 1);
    }
    if (islash == -1) return *this;
    return substr(islash + 1, length() - islash);
}
